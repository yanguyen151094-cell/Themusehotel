    ...
    <section ref={ref} className="py-20 md:py-28 bg-cream px-6 md:px-10 lg:px-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className={`text-center mb-14 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="font-serif text-3xl md:text-5xl text-brown font-bold mb-4">
            Ba Cơ Sở Đẳng Cấp
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {hotels.map((hotel, i) => (
            <div
              key={hotel.id}
              className={`group bg-white rounded-2xl overflow-hidden transition-all duration-700 delay-${i * 100} hover:-translate-y-1 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-brown/60 text-sm leading-relaxed mb-5 line-clamp-3">{hotel.shortDesc}</p>
