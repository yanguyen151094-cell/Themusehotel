...
export default function RoomsPage() {
  ...
  const filtered = filter === 'all' ? rooms : rooms.filter((r) => r.hotelId === filter);
              ...
              >
                <div className="relative h-52 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="bg-brown/80 text-white text-xs px-3 py-1 rounded-full">{room.hotelName}</span>
                  </div>
                </div>
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-cream">
                    ...
                    <button
                      onClick={() => { setSelectedRoom(room.name); setBookingModal(true); }}
