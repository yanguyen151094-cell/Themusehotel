    ...
    <main className="bg-cream font-sans min-h-screen">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-10">
              {/* Gallery */}
              <div>
                <div className="relative rounded-2xl overflow-hidden h-72 md:h-96 mb-3 cursor-pointer" onClick={() => setLightbox(hotel.gallery[galleryIndex])}>
                  <img src={hotel.gallery[galleryIndex]} alt={hotel.name} className="w-full h-full object-cover object-top" />
                ...
                <div className="grid grid-cols-4 gap-2">
                  {hotel.gallery.map((img, i) => (
                    <div
                      key={i}
                      className={`h-20 rounded-lg overflow-hidden cursor-pointer border-2 transition-all ${i === galleryIndex ? 'border-gold' : 'border-transparent'}`}
                        ...
                        <div className="sm:col-span-2 p-4 flex flex-col justify-between">
                          <div>
                            ...
                            <div className="flex flex-wrap gap-3 text-xs text-brown/60 mb-2">
                              ...
                              <span className="flex items-center gap-1"><i className="ri-hotel-bed-line text-gold"></i>{room.bedType}</span>
              ...
              <div>
                ...
                <div className="rounded-2xl overflow-hidden h-64">
                  <iframe
                    src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3730.8!2d${hotel.coordinates.lng}!3d${hotel.coordinates.lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2z${hotel.name}!5e0!3m2!1svi!2svn!4v1`}
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
              ...
              <div className="sticky top-24 space-y-4">
                ...
                <div className="bg-white rounded-2xl p-6 border border-cream-dark">
                  ...
                  <div className="space-y-3">
                    ...
                    <a href="https://wa.me/84888808818" target="_blank" rel="nofollow noreferrer" className="flex items-center gap-3 text-sm text-brown/70 hover:text-gold transition-colors cursor-pointer">
                      <div className="w-8 h-8 flex items-center justify-center bg-gold/10 rounded-lg">
                        <i className="ri-whatsapp-line text-gold text-sm"></i>
                      </div>
                      WhatsApp: +84 888 808 818
                    </a>
      ...
      {lightbox && (
        ...
        >
          ...
          <button className="absolute top-4 right-4 w-10 h-10 flex items-center justify-center text-white/70 hover:text-white cursor-pointer">
