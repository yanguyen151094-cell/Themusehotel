      ...
      {lightbox && (
        ...
        >
          <img
            src={lightbox}
            alt="Gallery"
            className="max-w-4xl max-h-[90vh] object-contain rounded-lg w-full"
          />
          <button
            className="absolute top-4 right-4 w-10 h-10 flex items-center justify-center text-white/70 hover:text-white cursor-pointer"
            onClick={() => setLightbox(null)}
          >
