        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-10">
            {hotels.map((hotel, i) => (
              <div
                key={hotel.id}
                className={`group grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-2xl overflow-hidden bg-white transition-all duration-700 hover:-translate-y-1 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} ${i % 2 === 1 ? 'lg:direction-rtl' : ''}`}
              ...
              >
                ...
                <div className={`p-8 md:p-10 flex flex-col justify-center ${i % 2 === 1 ? 'lg:order-1' : ''}`}>
                  ...
                  <p className="text-brown/60 text-sm leading-relaxed mb-6">{hotel.shortDesc}</p>
